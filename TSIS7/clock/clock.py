...
# mickey = pygame.transform.scale(mickeyclock, (H, W))
# hand = pygame.transform.scale(hand, (H, W))
# hand1 = pygame.transform.scale(hand1, (H , W))
# clock = pygame.time.Clock()
# clock.tick(60)
...
#     rot_handM, x = rotate(hand, x, H / 2\\ , W / 2 )
#     rot_handS, y = rotate(hand1, y, H / 2, W / 2)
    
    
#     screen.blit(mickey, (0, 0))
#     screen.blit(rot_handM, x)
#     screen.blit(rot_handS, y)
